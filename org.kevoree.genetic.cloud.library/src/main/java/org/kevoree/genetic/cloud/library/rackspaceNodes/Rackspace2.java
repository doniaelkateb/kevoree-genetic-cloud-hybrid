...
@DictionaryType({
        @DictionaryAttribute(name = "RAM", defaultValue = "1GB", optional = true),
        @DictionaryAttribute(name = "DiskSpace", defaultValue = "40GB", optional = true),
...
public class Rackspace2 extends PJavaSENode {
}
